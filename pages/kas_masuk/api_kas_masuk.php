<?php
    ...
    switch ($method) {
        case 'GET':
          $sql = "SELECT * FROM kas_masuk ".($key ?" WHERE idKas =$key":''); 
        break;
        case 'PUT': $sql = "UPDATE kas_masuk SET 
										no_rumah= '$no_rumah', 
										januari= '$januari', 
										februari= '$februari', 
										maret= '$maret', 
        ...
        break;
        case 'POST': $sql = "INSERT INTO kas_masuk( 
										no_rumah, 
										januari, 
										februari, 
										maret, 
        ...
        break;
        case 'DELETE':
           $sql = "DELETE FROM kas_masuk WHERE idKas = $key"; 
        break;
    }       
