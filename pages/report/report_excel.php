...
<?php
	...
	header("Content-Disposition: attachment; filename=Kas-Warga.xls");
...
<html>
	<head>
		  <style type="text/css">
	          ...
	          .tg .tg-ojok{background-color:#ffcc67;border-color:#000000;text-align:center;vertical-align:top}
	          .tg .tg-vswx{background-color:#fd6864;border-color:inherit;text-align:center;vertical-align:top}
	          .tg .tg-wnqi{background-color:#ffcc67;border-color:#000000;text-align:center;vertical-align:top}
...
<?php
		...
		echo "
			...
			<table>
				...
				<tr>
					<td><h3>Detail Pemasukan Selain IPL</h3></td>
					<td></td>
					<td><h3>Detail Pengeluaran</h3></td>
				</tr>
				<tr>
					<td>
						<table border='1'>
