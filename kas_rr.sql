...
-- Dumping database structure for kas_rr
CREATE DATABASE IF NOT EXISTS `kas_rr` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `kas_rr`;
...
-- Dumping data for table kas_rr.kas_keluar: ~0 rows (approximately)
...
-- Dumping data for table kas_rr.kas_masuk: ~15 rows (approximately)
...
DROP TABLE IF EXISTS `kas_masuk_lain`;
...
-- Dumping data for table kas_rr.menu: ~2 rows (approximately)
DELETE FROM `menu`;
...
-- Dumping data for table kas_rr.modul: ~4 rows (approximately)
DELETE FROM `modul`;
...
INSERT INTO `user` (`id_user`, `nama_lengkap`, `usernm`, `passwd`, `level`, `last_login`) VALUES
	(1, 'Administrator', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', '2020-03-15 19:30:45');
